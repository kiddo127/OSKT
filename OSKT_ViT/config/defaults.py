...
_C.refining_weight_chain = False
_C.training_student_model = False
_C.weight_chain_dim = 8
_C.Splitting_Epoch = 1
_C.student_dim = 384
_C.few_shot_seed = None
_C.few_shot_ratio = 0.1
...
_C.SOLVER.TRAIN_SEGMENT = 1 # 将联合数据集的每个epoch分为几段
_C.SOLVER.MinLRScale = 1 # 对lr_min的缩放器
# Name of optimizer
