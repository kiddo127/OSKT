...
class DefaultConfig:
    ...
    def __init__(self):
        ...
        # self.BASE_LR = 0.0065  # base learning rate
        # self.BASE_LR = 0.00035*64  # base learning rate
        # self.BASE_LR = 0.00035/2.8284271247461903  # base learning rate
        ...
        # self.WARMUP_EPOCHS = 10  # warm up epochs
        # self.WARMUP_METHOD = "linear"  # option: 'linear','constant'
        # self.STEPS = [4+self.WARMUP_EPOCHS, 6+self.WARMUP_EPOCHS, 7+self.WARMUP_EPOCHS]
        ...
        # self.WARMUP_EPOCHS = 10  # warm up epochs
        # self.WARMUP_METHOD = "linear"  # option: 'linear','constant'
        # self.STEPS = [3+self.WARMUP_EPOCHS, 5+self.WARMUP_EPOCHS, 7+self.WARMUP_EPOCHS]
